    ...
    if request.method == "POST":
        if 'file' in request.files:
            ...
            if file_extension == 'jpg':
                ...
                line_y1 = text_y1-12
                cv2.line(img, (0, line_y1),
                         (img.shape[1], line_y1), (0, 0, 0), 30)
                cv2.putText(img, text1, (text_x1, text_y1), font,
                ...
                line_y2 = text_y2-12
                cv2.line(saved_image, (0, line_y2),
                         (saved_image.shape[1], line_y2), (0, 0, 0), 30)
                cv2.putText(saved_image, text2, (text_x2, text_y2),
                ...
                gap_image = np.full(
                    (max(img.shape[0], saved_image.shape[0]), gap_width, 3), background_color, dtype=np.uint8)
